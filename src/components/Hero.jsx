                    ...
                    <div className="col-12 col-lg-6 text-center text-lg-start letras_claras descripcion p-3 p-md-0">
                        <div className="d-flex flex-column align-items-center align-items-lg-start">
                            ...
                            <div className="d-flex flex-wrap gap-3 pt-4 justify-content-center justify-content-lg-start mb-3">
                                <TechIcon src="/assets/img/java.png" name="Java" />
                                <TechIcon src="/assets/img/html-5.png" name="HTML5" />
                                <TechIcon src="/assets/img/js.png" name="JavaScript" />
                                <TechIcon src="/assets/img/react.svg" name="React" />
                                <TechIcon src="/assets/img/android.png" name="Android" />
                                <TechIcon src="/assets/img/flutter.svg" name="Flutter" />
                                <TechIcon src="/assets/img/servidor-sql.png" name="SQL Server" />
                                <TechIcon src="/assets/img/GIT.png" name="Git" />
                            </div>
